...
function createNew(e) {
  ...
  if (photo.value == "") {
    cardImage.src =
      "https://www.marsh.com/content/dam/marsh/Imagery/marsh-2/thumbnail-768x768/airline-in-clouds.jpg";
  } else {
...
function editPlace(e) {
  ...
  let newURL = window.prompt(
    "Did you have a new image URL? [Please enter URL only]"
  );
